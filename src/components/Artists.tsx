...
<section className={`py-8 bg-opacity-60 backdrop-blur-md mx-5 rounded-3xl`} style={{background: 'linear-gradient(40deg, rgba(255,255,255,1) 0%, rgba(255,255,255,0.85) 40%, rgba(255,255,255,0.4) 100%)'}} id="artists">
  <div className={`container mx-auto px-2 pt-4 pb-12 text-black`}>
    ...
    <div className="grid md:grid-cols-4 gap-5 grid-cols-2">
      ...
      <div className="bg-primary w-50 h-50 rounded hover:shadow-artistBg hover:scale-105 hover:font-bold hover:cursor-pointer">
        <div className="scale-90 text-center">
          <img className="rounded hover:scale-90 hover:rounded-2xl hover:shadow-md" src="https://res.cloudinary.com/projectartichoke/image/upload/v1662936745/Artists/Ponay%E7%9A%84%E5%8E%9F%E5%BC%8F%E5%A4%A7%E6%A8%82%E9%9A%8A_cfxxv2.png" />
        ...
        <div className="popup-content container mx-auto bg-gray-100 rounded-3xl bg-opacity-20 backdrop-blur-sm shadow-sm" style={{maxWidth: "80vw", minWidth: "50vw", width: 'auto', minHeight: '50vh'}}>
          <div className="flex flex-col space-y-5 items-center">
            <img className="w-2/3 md:w-1/3 lg:w-1/3 mt-5" src="https://res.cloudinary.com/projectartichoke/image/upload/v1662936745/Artists/Ponay%E7%9A%84%E5%8E%9F%E5%BC%8F%E5%A4%A7%E6%A8%82%E9%9A%8A_cfxxv2.png"/>
      ...
      <div className="bg-primary w-50 h-50 rounded hover:shadow-artistBg hover:scale-105 hover:font-bold hover:cursor-pointer">
        <div className="scale-90 text-center">
          <img className="rounded hover:scale-90 hover:rounded-2xl hover:shadow-md" src="https://res.cloudinary.com/projectartichoke/image/upload/v1662936947/Artists/%E8%A9%B9%E6%A3%AE%E6%B7%AE_s2wct7.png" />
        ...
        <div className="popup-content container mx-auto bg-gray-100 rounded-3xl bg-opacity-20 backdrop-blur-sm shadow-sm" style={{maxWidth: "80vw", minWidth: "50vw", width: 'auto', minHeight: '50vh'}}>
          <div className="flex flex-col space-y-5 items-center">
            <img className="w-2/3 md:w-1/3 lg:w-1/3 mt-5" src="https://res.cloudinary.com/projectartichoke/image/upload/v1662936947/Artists/%E8%A9%B9%E6%A3%AE%E6%B7%AE_s2wct7.png"/>
      ...
      <div className="bg-primary w-50 h-50 rounded hover:shadow-artistBg hover:scale-105 hover:font-bold hover:cursor-pointer">
        ...
        <div className="popup-content container mx-auto bg-gray-100 rounded-3xl bg-opacity-20 backdrop-blur-sm shadow-sm" style={{maxWidth: "80vw", minWidth: "50vw", width: 'auto', minHeight: '50vh'}}>
          <div className="flex flex-col space-y-5 items-center">
            <img className="w-2/3 md:w-1/3 lg:w-1/3 mt-5" src="https://res.cloudinary.com/projectartichoke/image/upload/v1662936722/Artists/%E5%8F%B0%E7%8E%96%E7%B7%9A%E6%A8%82%E5%9C%98_cpwodb.png"/>
      ...
      <div className="bg-primary w-50 h-50 rounded hover:shadow-artistBg hover:scale-105 hover:font-bold hover:cursor-pointer">
        <div className="scale-90 text-center">
          <img className="rounded hover:scale-90 hover:rounded-2xl hover:shadow-md" src="https://res.cloudinary.com/projectartichoke/image/upload/v1662936915/Artists/%E6%A1%91%E5%B8%83%E4%BC%8A_hv0azm.png" />
        ...
        <div className="popup-content container mx-auto bg-gray-100 rounded-3xl bg-opacity-20 backdrop-blur-sm shadow-sm" style={{maxWidth: "80vw", minWidth: "50vw", width: 'auto', minHeight: '50vh'}}>
          <div className="flex flex-col space-y-5 items-center">
            <img className="w-2/3 md:w-1/3 lg:w-1/3 mt-5" src="https://res.cloudinary.com/projectartichoke/image/upload/v1662936915/Artists/%E6%A1%91%E5%B8%83%E4%BC%8A_hv0azm.png"/>
      ...
      <div className="bg-primary w-50 h-50 rounded hover:shadow-artistBg hover:scale-105 hover:font-bold hover:cursor-pointer">
        <div className="scale-90 text-center">
          <img className="rounded hover:scale-90 hover:rounded-2xl hover:shadow-md" src="https://res.cloudinary.com/projectartichoke/image/upload/v1662936732/Artists/%E5%A4%AA%E5%B7%B4%E5%A1%B1%E8%9D%B8%E7%89%9B%E7%8F%AD_bc7qvl.png" />
        ...
        <div className="popup-content container mx-auto bg-gray-100 rounded-3xl bg-opacity-20 backdrop-blur-sm shadow-sm" style={{maxWidth: "80vw", minWidth: "50vw", width: 'auto', minHeight: '50vh'}}>
          <div className="flex flex-col space-y-5 items-center">
            <img className="w-2/3 md:w-1/3 lg:w-1/3 mt-5" src="https://res.cloudinary.com/projectartichoke/image/upload/v1662936732/Artists/%E5%A4%AA%E5%B7%B4%E5%A1%B1%E8%9D%B8%E7%89%9B%E7%8F%AD_bc7qvl.png"/>
      ...
      <div className="bg-primary w-50 h-50 rounded hover:shadow-artistBg hover:scale-105 hover:font-bold hover:cursor-pointer">
        <div className="scale-90 text-center">
          <img className="rounded hover:scale-90 hover:rounded-2xl hover:shadow-md" src="https://res.cloudinary.com/projectartichoke/image/upload/v1662936656/Artists/Matzka_b1dmj8.png" />
        ...
        <div className="popup-content container mx-auto bg-gray-100 rounded-3xl bg-opacity-20 backdrop-blur-sm shadow-sm" style={{maxWidth: "80vw", minWidth: "50vw", width: 'auto', minHeight: '50vh'}}>
          <div className="flex flex-col space-y-5 items-center">
            <img className="w-2/3 md:w-1/3 lg:w-1/3 mt-5" src="https://res.cloudinary.com/projectartichoke/image/upload/v1662936656/Artists/Matzka_b1dmj8.png"/>
    ...
    <div className="mt-5 grid md:grid-cols-4 gap-5 grid-cols-2">
      ...
      <div className="bg-primary w-50 h-50 rounded hover:shadow-artistBg hover:scale-105 hover:font-bold hover:cursor-pointer">
        <div className="scale-90 text-center">
          <img className="rounded hover:scale-90 hover:rounded-2xl hover:shadow-md" src="https://res.cloudinary.com/projectartichoke/image/upload/v1662936727/Artists/%E9%9B%B7%E6%93%8E_vhss7i.png" />
        ...
        <div className="popup-content container mx-auto bg-gray-100 rounded-3xl bg-opacity-20 backdrop-blur-sm shadow-sm" style={{maxWidth: "80vw", minWidth: "50vw", width: 'auto', minHeight: '50vh'}}>
          <div className="flex flex-col space-y-5 items-center">
            <img className="w-2/3 md:w-1/3 lg:w-1/3 mt-5" src="https://res.cloudinary.com/projectartichoke/image/upload/v1662936727/Artists/%E9%9B%B7%E6%93%8E_vhss7i.png"/>
      ...
      <div className="bg-primary w-50 h-50 rounded hover:shadow-artistBg hover:scale-105 hover:font-bold hover:cursor-pointer">
        <div className="scale-90 text-center">
          <img className="rounded hover:scale-90 hover:rounded-2xl hover:shadow-md" src="https://res.cloudinary.com/projectartichoke/image/upload/v1662936721/Artists/%E5%A4%A7%E4%BA%A8_dgfgvv.png" />
        ...
        <div className="popup-content container mx-auto bg-gray-100 rounded-3xl bg-opacity-20 backdrop-blur-sm shadow-sm" style={{maxWidth: "80vw", minWidth: "50vw", width: 'auto', minHeight: '50vh'}}>
          <div className="flex flex-col space-y-5 items-center">
            <img className="w-2/3 md:w-1/3 lg:w-1/3 mt-5" src="https://res.cloudinary.com/projectartichoke/image/upload/v1662936721/Artists/%E5%A4%A7%E4%BA%A8_dgfgvv.png"/>
      ...
      <div className="bg-primary w-50 h-50 rounded hover:shadow-artistBg hover:scale-105 hover:font-bold hover:cursor-pointer">
        <div className="scale-90 text-center">
          <img className="rounded hover:scale-90 hover:rounded-2xl hover:shadow-md" src="https://res.cloudinary.com/projectartichoke/image/upload/v1662936733/Artists/%E4%BF%9D%E5%8D%9C_%E5%B7%B4%E7%9D%A3%E8%B7%AF_xei6ez.png" />
        ...
        <div className="popup-content container mx-auto bg-gray-100 rounded-3xl bg-opacity-20 backdrop-blur-sm shadow-sm" style={{maxWidth: "80vw", minWidth: "50vw", width: 'auto', minHeight: '50vh'}}>
          <div className="flex flex-col space-y-5 items-center">
            <img className="w-2/3 md:w-1/3 lg:w-1/3 mt-5" src="https://res.cloudinary.com/projectartichoke/image/upload/v1662936733/Artists/%E4%BF%9D%E5%8D%9C_%E5%B7%B4%E7%9D%A3%E8%B7%AF_xei6ez.png"/>
      ...
      <div className="bg-primary w-50 h-50 rounded hover:shadow-artistBg hover:scale-105 hover:font-bold hover:cursor-pointer">
        <div className="scale-90 text-center">
          <img className="rounded hover:scale-90 hover:rounded-2xl hover:shadow-md" src="https://res.cloudinary.com/projectartichoke/image/upload/v1662936710/Artists/%E7%B0%A1%E7%87%95%E6%98%A5_gmlstm.png" />
        ...
        <div className="popup-content container mx-auto bg-gray-100 rounded-3xl bg-opacity-20 backdrop-blur-sm shadow-sm" style={{maxWidth: "80vw", minWidth: "50vw", width: 'auto', minHeight: '50vh'}}>
          <div className="flex flex-col space-y-5 items-center">
            <img className="w-2/3 md:w-1/3 lg:w-1/3 mt-5" src="https://res.cloudinary.com/projectartichoke/image/upload/v1662936710/Artists/%E7%B0%A1%E7%87%95%E6%98%A5_gmlstm.png"/>
      ...
      <div className="bg-primary w-50 h-50 rounded hover:shadow-artistBg hover:scale-105 hover:font-bold hover:cursor-pointer">
        <div className="scale-90 text-center">
          <img className="rounded hover:scale-90 hover:rounded-2xl hover:shadow-md" src="https://res.cloudinary.com/projectartichoke/image/upload/v1662936722/Artists/%E9%98%BF%E7%88%86_ecsfcw.png" />
        ...
        <div className="popup-content container mx-auto bg-gray-100 rounded-3xl bg-opacity-20 backdrop-blur-sm shadow-sm" style={{maxWidth: "80vw", minWidth: "50vw", width: 'auto', minHeight: '50vh'}}>
          <div className="flex flex-col space-y-5 items-center">
            <img className="w-2/3 md:w-1/3 lg:w-1/3 mt-5" src="https://res.cloudinary.com/projectartichoke/image/upload/v1662936722/Artists/%E9%98%BF%E7%88%86_ecsfcw.png"/>
