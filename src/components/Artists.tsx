      ...
      <div className="bg-primary w-50 h-50 rounded hover:shadow-artistBg hover:scale-105 hover:font-bold hover:cursor-pointer">
        ...
        <div className="popup-content container mx-auto bg-gray-100 rounded-3xl bg-opacity-20 backdrop-blur-sm shadow-sm" style={{maxWidth: "70vw", minWidth: "60vw", width: 'auto', minHeight: '50vh'}}>
          <div className="flex flex-col space-y-5 items-center">
            ...
            <text className="px-5 font-TaipeiLight pb-5 text-sm md:text-xl">來自臺東的Ponay，讀音「補奈」，東海岸阿美族人，來自臺東成功小港部落。Ponay在YouTube頻道推出一系列Cover（翻唱）影片，以原住民卡拉OK唱腔重新詮釋舒米恩、徐懷鈺、蕭亞軒、S.H.E等多首經典歌曲，已在網路上引發一陣陣原式強風。<br/>一臺電子琴、一支麥克風，Ponay用來自東海岸的海派氣口（khuì-kháu）、左轉右轉再迴轉的華麗轉音，以及埋藏無數彩蛋的驚奇編曲。自帶回音與超濃情感的百變詮釋，滿滿的原式 Cover，原力席捲了原唱與無數網友。</text>
          </div>
        </div>
      </Popup>
      <Popup trigger={
      <div className="bg-primary w-50 h-50 rounded hover:shadow-artistBg hover:scale-105 hover:font-bold hover:cursor-pointer">
        ...
        <div className="popup-content container mx-auto bg-gray-100 rounded-3xl bg-opacity-20 backdrop-blur-sm shadow-sm" style={{maxWidth: "70vw", minWidth: "60vw", width: 'auto', minHeight: '50vh'}}>
          <div className="flex flex-col space-y-5 items-center">
            ...
            <text className="px-5 font-TaipeiLight pb-5 text-sm md:text-xl">詹森淮音樂風格清新自然，演唱時多半以一把木吉他伴奏，曾在2013年與星巴克合作200場live演出的她，演出經驗相當豐富。專輯《我想再唱起歌》曾入圍2017第八屆金音獎/最佳民謠專輯獎。<br/>其歌詞創作的靈感來源，多半來自大自然，如大海、星辰、土地等，亦不時反映出世界與社會所帶給她的感觸，歌詞與歌聲深具感性知性，頗富哲學性，如華語樂壇的一處清流。
          </text>
          </div>
        </div>
      </Popup>
      ...
      <div className="bg-primary w-50 h-50 rounded hover:shadow-artistBg hover:scale-105 hover:font-bold hover:cursor-pointer">
        ...
        <div className="popup-content container mx-auto bg-gray-100 rounded-3xl bg-opacity-20 backdrop-blur-sm shadow-sm" style={{maxWidth: "70vw", minWidth: "60vw", width: 'auto', minHeight: '50vh'}}>
          <div className="flex flex-col space-y-5 items-center">
            ...
            <text className="px-5 font-TaipeiLight pb-5 text-sm md:text-xl">Matzka為台灣音樂創作人、製作人，其音樂風格以雷鬼為主，並混合爵士樂、民謠、重金屬、Rap和嘻哈等元素，來自台東的原住民，其曲風也帶有濃厚的原住民風格。<br />2011年以專輯《MATZKA》獲得第22屆金曲獎最佳音樂獎，2013年以專輯《089》獲得第24屆金曲獎最佳音樂獎，2016年以首張個人專輯《東南美》入圍第27屆金曲獎最佳國語男歌手、第七屆金音創作獎。</text>
          </div>
        </div>
      </Popup>
    </div>
      ...
      <div className="bg-primary w-50 h-50 rounded hover:shadow-artistBg hover:scale-105 hover:font-bold hover:cursor-pointer">
        ...
        <div className="popup-content container mx-auto bg-gray-100 rounded-3xl bg-opacity-20 backdrop-blur-sm shadow-sm" style={{maxWidth: "70vw", minWidth: "60vw", width: 'auto', minHeight: '50vh'}}>
          <div className="flex flex-col space-y-5 items-center">
            ...
            <text className="px-5 font-TaipeiLight pb-5 text-sm md:text-xl">排灣族音樂家，以指彈吉他（finger style）演奏技巧聞名，以行雲流水的彈奏技巧融合豐富的音樂風格，是個擅於用吉他表達情感的音樂人。曾於2013年發行演奏專輯《我愛台坂》，入圍金曲獎演奏類最佳作曲人獎項。<br/>除個人音樂作品外，亦製作多項影視作品配樂，曾於2008年以《Ohaeva.哥哥》入圍第43屆電視金鐘獎音效獎，2010年以《看見天堂》入圍第45屆電視金鐘音效獎，2016年以電影《只要我長大》主題曲《愛不用說話》入圍第53屆金馬獎最佳原創電影歌曲。
</text>
          </div>
        </div>
      </Popup>
      ...
      <div className="bg-primary w-50 h-50 rounded hover:shadow-artistBg hover:scale-105 hover:font-bold hover:cursor-pointer">
        ...
        <div className="popup-content container mx-auto bg-gray-100 rounded-3xl bg-opacity-20 backdrop-blur-sm shadow-sm" style={{maxWidth: "70vw", minWidth: "60vw", width: 'auto', minHeight: '50vh'}}>
          <div className="flex flex-col space-y-5 items-center">
            ...
            <text className="px-5 font-TaipeiLight pb-5 text-sm md:text-xl">古謠之於簡燕春，是自小被母親拎在身邊的她，再自然不過的習得。作為部落祭歌團的一員，簡燕春的身體裡，將古謠內化為太巴塱部落歷史的索引。在每一首歌的吟唱中，不論是祭歌或是日常古謠，隨空氣逸散四處的歌聲，帶領著她回到過去生命的吉光片羽，口述著她與太巴塱部落的關係，也冀望聆聽者可以將故事忠實地傳遞給下個世代。<br/>抱著傳承傳統古調的期待，81歲的簡燕春發行了個人專輯《Ira…a micekor 靜靜地等待著》，並一舉獲得第33屆金曲獎最佳原住民歌手獎。</text>
          </div>
        </div>
      </Popup>
      <Popup trigger={
