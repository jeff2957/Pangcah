      ...
      <div className="bg-primary w-50 h-50 rounded hover:shadow-artistBg hover:scale-105 hover:font-bold hover:cursor-pointer">
        ...
        <div className="popup-content container mx-auto bg-gray-100 rounded-3xl bg-opacity-20 backdrop-blur-md shadow-sm" style={{maxWidth: "70vw", minWidth: "60vw", width: 'auto', minHeight: '50vh'}}>
          <div className="flex flex-col space-y-5 items-center">
            ...
            <text className="px-10 font-TaipeiLight pb-5 text-sm md:text-xl">來自臺東的Ponay，讀音「補奈」，東海岸阿美族人，來自臺東成功小港部落。Ponay在YouTube頻道推出一系列Cover（翻唱）影片，以原住民卡拉OK唱腔重新詮釋舒米恩、徐懷鈺、蕭亞軒、S.H.E等多首經典歌曲，已在網路上引發一陣陣原式強風。<br/>一臺電子琴、一支麥克風，Ponay用來自東海岸的海派氣口（khuì-kháu）、左轉右轉再迴轉的華麗轉音，以及埋藏無數彩蛋的驚奇編曲。自帶回音與超濃情感的百變詮釋，滿滿的原式 Cover，原力席捲了原唱與無數網友。</text>
          </div>
        </div>
      </Popup>
      <Popup trigger={
      <div className="bg-primary w-50 h-50 rounded hover:shadow-artistBg hover:scale-105 hover:font-bold hover:cursor-pointer">
        ...
        <div className="popup-content container mx-auto bg-gray-100 rounded-3xl bg-opacity-20 backdrop-blur-md shadow-sm" style={{maxWidth: "70vw", minWidth: "60vw", width: 'auto', minHeight: '50vh'}}>
          <div className="flex flex-col space-y-5 items-center">
            ...
            <text className="px-10 font-TaipeiLight pb-5 text-sm md:text-xl">詹森淮音樂風格清新自然，演唱時多半以一把木吉他伴奏，曾在2013年與星巴克合作200場live演出的她，演出經驗相當豐富。專輯《我想再唱起歌》曾入圍2017第八屆金音獎/最佳民謠專輯獎。<br/>其歌詞創作的靈感來源，多半來自大自然，如大海、星辰、土地等，亦不時反映出世界與社會所帶給她的感觸，歌詞與歌聲深具感性知性，頗富哲學性，如華語樂壇的一處清流。
          </text>
          </div>
        </div>
      </Popup>
      ...
      <div className="bg-primary w-50 h-50 rounded hover:shadow-artistBg hover:scale-105 hover:font-bold hover:cursor-pointer">
        ...
        <div className="popup-content container mx-auto bg-gray-100 rounded-3xl bg-opacity-20 backdrop-blur-md shadow-sm" style={{maxWidth: "70vw", minWidth: "60vw", width: 'auto', minHeight: '50vh'}}>
          <div className="flex flex-col space-y-5 items-center">
            ...
            <text className="px-10 font-TaipeiLight pb-5 text-sm md:text-xl">臺灣的東部，花蓮，是台玖線團員相遇的地方、發跡夢想、創作、表演的地方。當年單純想唱自己的歌為出發，嘗試不同音樂風格將生活中的感動、生命的互動用搖滾、藍調、原民風、輕音樂、和聲、福音音樂或族語創作等等呈現。<br/>以台玖線為團名的原因，就是以臺九線公路諧音為命名，對團員們來說，這是一條臺灣最美、最長的公路，就像人的一生一樣，有起有落，有高山有低谷，有海洋有平原。靠著那加給我們力量的，我們不忘初衷『捍衛夢想，拒絕放棄』。</text>
          </div>
        </div>
      </Popup>
      <Popup trigger={
      <div className="bg-primary w-50 h-50 rounded hover:shadow-artistBg hover:scale-105 hover:font-bold hover:cursor-pointer">
        ...
        <div className="popup-content container mx-auto bg-gray-100 rounded-3xl bg-opacity-20 backdrop-blur-md shadow-sm" style={{maxWidth: "70vw", minWidth: "60vw", width: 'auto', minHeight: '50vh'}}>
          <div className="flex flex-col space-y-5 items-center">
            ...
            <text className="px-10 font-TaipeiLight pb-5 text-sm md:text-xl">一個在年輕的身體裡住著古老靈魂，來自臺東山與海交界處的一個卑南族古老部落，自幼學習卑南族文化的桑布伊，不僅學會族語和部落歌曲吟唱技巧，更將他對傳統文化的了解，藉由歌唱的方式傳承分享。<br/>桑布伊曾於2013年以專輯《dalan》榮獲第24屆金曲獎最佳原住民語歌手獎，2017年以《椏幹》榮獲第28屆金曲獎最佳原住民語歌手獎、最佳演唱錄音專輯獎，2021年以《得力量 pulu'em》榮獲第32屆金曲獎最佳原住民語歌手獎。</text>
          </div>
        </div>
      </Popup>
      <Popup trigger={
      ...
      <div className="bg-primary w-50 h-50 rounded hover:shadow-artistBg hover:scale-105 hover:font-bold hover:cursor-pointer">
        ...
        <div className="popup-content container mx-auto bg-gray-100 rounded-3xl bg-opacity-20 backdrop-blur-md shadow-sm" style={{maxWidth: "70vw", minWidth: "60vw", width: 'auto', minHeight: '50vh'}}>
          <div className="flex flex-col space-y-5 items-center">
            ...
            <text className="px-10 font-TaipeiLight pb-5 text-sm md:text-xl">Matzka為台灣音樂創作人、製作人，其音樂風格以雷鬼為主，並混合爵士樂、民謠、重金屬、Rap和嘻哈等元素，來自台東的原住民，其曲風也帶有濃厚的原住民風格。<br />2011年以專輯《MATZKA》獲得第22屆金曲獎最佳音樂獎，2013年以專輯《089》獲得第24屆金曲獎最佳音樂獎，2016年以首張個人專輯《東南美》入圍第27屆金曲獎最佳國語男歌手、第七屆金音創作獎。</text>
          </div>
        </div>
      </Popup>
    </div>
      ...
      <div className="bg-primary w-50 h-50 rounded hover:shadow-artistBg hover:scale-105 hover:font-bold hover:cursor-pointer">
        ...
        <div className="popup-content container mx-auto bg-gray-100 rounded-3xl bg-opacity-20 backdrop-blur-md shadow-sm" style={{maxWidth: "70vw", minWidth: "60vw", width: 'auto', minHeight: '50vh'}}>
          <div className="flex flex-col space-y-5 items-center">
            ...
            <text className="px-10 font-TaipeiLight pb-5 text-sm md:text-xl">饒舌歌手、製作人，來自花蓮的阿美族人，嘗試以生活經驗結合部落文化、族語元素作為創作題材。2020年改編阿美族古謠共同演唱知名饒舌Cypher《我阿姨也癢》， 而後更推出《DACI‘喇季》、《Kaying 改硬》等歌曲以幽默詼諧的歌詞連結自身文化，透過自己的語言唱出屬於自己的故事，更藉由個人鮮明的唱腔與風格詮釋出獨特的饒舌音樂。2022年以《Maliepah 聚》入圍臺灣原創流行音樂大賽。</text>
          </div>
        </div>
      </Popup>
      <Popup trigger={
      <div className="bg-primary w-50 h-50 rounded hover:shadow-artistBg hover:scale-105 hover:font-bold hover:cursor-pointer">
        ...
        <div className="popup-content container mx-auto bg-gray-100 rounded-3xl bg-opacity-20 backdrop-blur-md shadow-sm" style={{maxWidth: "70vw", minWidth: "60vw", width: 'auto', minHeight: '50vh'}}>
          <div className="flex flex-col space-y-5 items-center">
            ...
            <text className="px-10 font-TaipeiLight pb-5 text-sm md:text-xl">排灣族音樂家，以指彈吉他（finger style）演奏技巧聞名，以行雲流水的彈奏技巧融合豐富的音樂風格，是個擅於用吉他表達情感的音樂人。曾於2013年發行演奏專輯《我愛台坂》，入圍金曲獎演奏類最佳作曲人獎項。<br/>除個人音樂作品外，亦製作多項影視作品配樂，曾於2008年以《Ohaeva.哥哥》入圍第43屆電視金鐘獎音效獎，2010年以《看見天堂》入圍第45屆電視金鐘音效獎，2016年以電影《只要我長大》主題曲《愛不用說話》入圍第53屆金馬獎最佳原創電影歌曲。
</text>
          </div>
        </div>
      </Popup>
      ...
      <div className="bg-primary w-50 h-50 rounded hover:shadow-artistBg hover:scale-105 hover:font-bold hover:cursor-pointer">
        ...
        <div className="popup-content container mx-auto bg-gray-100 rounded-3xl bg-opacity-20 backdrop-blur-md shadow-sm" style={{maxWidth: "70vw", minWidth: "60vw", width: 'auto', minHeight: '50vh'}}>
          <div className="flex flex-col space-y-5 items-center">
            ...
            <text className="px-10 font-TaipeiLight pb-5 text-sm md:text-xl">古謠之於簡燕春，是自小被母親拎在身邊的她，再自然不過的習得。作為部落祭歌團的一員，簡燕春的身體裡，將古謠內化為太巴塱部落歷史的索引。在每一首歌的吟唱中，不論是祭歌或是日常古謠，隨空氣逸散四處的歌聲，帶領著她回到過去生命的吉光片羽，口述著她與太巴塱部落的關係，也冀望聆聽者可以將故事忠實地傳遞給下個世代。<br/>抱著傳承傳統古調的期待，81歲的簡燕春發行了個人專輯《Ira…a micekor 靜靜地等待著》，並一舉獲得第33屆金曲獎最佳原住民歌手獎。</text>
          </div>
        </div>
      </Popup>
      <Popup trigger={
      ...
      <div className="bg-primary w-50 h-50 rounded hover:shadow-artistBg hover:scale-105 hover:font-bold hover:cursor-pointer">
        ...
        <div className="popup-content container mx-auto bg-gray-100 rounded-3xl bg-opacity-20 backdrop-blur-md shadow-sm" style={{maxWidth: "70vw", minWidth: "60vw", width: 'auto', minHeight: '50vh'}}>
          <div className="flex flex-col space-y-5 items-center">
            ...
            <text className="px-10 font-TaipeiLight pb-5 text-sm md:text-xl">生活有時序，季節有更迭，年齡有排序。在不同的年齡階層裡，合作分工著維持一個部落（國家）的正常運作，每一個階層就像充滿生命力的齒輪，彼此相連緊扣運轉，缺一不可。</text>
          </div>
        </div>
      </Popup>
    </div>
