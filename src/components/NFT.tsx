...
return (
<section className={`py-8 backdrop-blur-md mx-5 rounded-3xl bg-black bg-opacity-95`} 
// style={{background: ''}} 
id="NFT">
  <div className={`mx-auto px-2 pt-4 pb-12`}>
    ...
    <div className="grid md:grid-cols-3 sm:grid-cols-1 place-items-center">
        <div className="text-center">
            {/* <img className="rounded hover:scale-90 hover:rounded-2xl hover:shadow-md" src={nfts.link} /> */}
            <iframe src="https://giphy.com/embed/II6srLddMbfMmhWqiF" width="340" height="340" className="giphy-embed" allowFullScreen></iframe>
            <h2 className="lg:text-xl text-md font-bold font-TaipeiBold text-white">Kakacawan</h2>
        </div>
        <div className="text-center">
            {/* <img className="rounded hover:scale-90 hover:rounded-2xl hover:shadow-md" src={nfts.link} /> */}
            ...
            <h2 className="lg:text-xl text-md font-bold font-TaipeiBold text-white">Malataw</h2>
        </div>
        <div className="text-center">
            {/* <img className="rounded hover:scale-90 hover:rounded-2xl hover:shadow-md" src={nfts.link} /> */}
            ...
            <h2 className="lg:text-xl text-md font-bold font-TaipeiBold text-white">Afalong</h2>
        </div>
    </div>
  </div>
</section>
